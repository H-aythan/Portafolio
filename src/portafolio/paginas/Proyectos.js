        ...
        <div className="relative w-full sm:animate-move-t xl:bg-proyectos bg-cover">
            ...
            <div className="absolute mb-10 w-full xl:h-full flex flex-col ">
                ...
                <div className="w-full flex-col xl:flex-row xl:h-1/2 flex items-center justify-end px-2">
                    ...
                    <p className="xl:w-72 px-3 text-justify opacity-75 flex-grow sm:flex-grow-0 md:text-3xl xl:text-xl">Una apliacion que muestra web que muestra una galeria de perritos donde puedes seleccionar tu raza preferida para ver mas imagenes sobre esa raza , fue desarrollada usando la api Dog API.</p>
                ...
                <div className="w-full mt-5 sm:h-1/2 flex flex-col xl:flex-row items-center justify-start px-2">
                    ...
                    <p className="xl:w-72 px-3 text-justify opacity-75 flex-grow sm:flex-grow-0 md:text-3xl xl:text-xl">Una apliacon de registros de usaurios donde se muestra las acciones mas basicas de las aplicaciones como leer, agregar, borrar y actualizar </p>
